...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $statement = $conexion->prepare(
        'INSERT INTO tipoanuncio(id_tipo_anuncio, descripcion, costo, metros, numCuartos, numBathroom, direccion, distrito, departamento, thumb) VALUES(NULL, :descripcion, :costo, :metros, :numCuartos, :numBathroom, :direccion, :distrito, :departamento, :thumb)'
    );
