...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $statement = $conexion->prepare('UPDATE tipoanuncio SET descripcion = :descripcion, costo = :costo, metros = :metros, numCuartos = :numCuartos, numBathroom = :numBathroom, direccion = :direccion, distrito = :distrito, departamento = :departamento, thumb = :thumb WHERE id_tipo_anuncio = :id');
