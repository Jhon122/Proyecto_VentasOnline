...
if(isset($_POST["ingresar"])){
	...
	$sql = "SELECT idusuarios FROM usuarios 
			WHERE usuario = '$usuario' AND password = '$password_encriptada' AND status = '1' ";
...
if(isset($_POST["registrar"])){
	...
	if($filas > 0){
		...
		$sqlusuario = "INSERT  INTO 
			...
			VALUES ('$nombre','$correo','$usuario','$password_encriptada', '1')";
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="white" id="id-text2">de Administradores</span>
								</h1>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												<i class="ace-icon fa fa-sticky-note-o white"></i>
											...
											<div class="social-or-login center">
												<span class="bigger-110">CAVIEDES SAC</span>
											</div>
	...
	<div class="space-6"></div>
		...
		<form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST" >
			<fieldset>
				...
				<!--Label de aceptar terminos de uso-->
				<!--<label class="block">
					<input type="checkbox" class="ace" />
						<span class="lbl">
						Acepto los
